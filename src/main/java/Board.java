...
public class Board extends JPanel implements ActionListener {
    ...
    private final int B_WIDTH = 300; //size of the board
    private final int B_HEIGHT = 300; //size of the board
    private final int DOT_SIZE = 10; //size of the apple and the dot of the snake
    private final int ALL_DOTS = 900; //maximum number of possible dots on the board (900 = (300*300)/(10*10))
    private final int RAND_POS = 29; //to calculate a random position for an apple.
    ...
    public void locateSnake(int x,int y){
        this.x[0]=x;
        this.y[0]=y;
    }
